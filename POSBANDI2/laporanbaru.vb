...
Public Class laporanbaru
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "POSBANDI2.laporanbaru.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_pTglAwal() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_pTglAkhir() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedlaporanbaru
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As laporanbaru = New laporanbaru()
        rpt.Site = Me.Site
        Return rpt
    End Function
